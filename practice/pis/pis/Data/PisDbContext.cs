...
public class PisDbContext: DbContext, IPisDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Drug>().HasData(
            ...
            new Drug("Praziquantel Tablet, Film-coated 200mg","D102",500.0),
            ...
            new Drug("Ivermectin Tablet 6mg","D106",500.0),
            new Drug("Praziquantel Tablet, Film-coated 300mg","D107",500.0),
            new Drug("Albendazole Tablets, Chewable 400mg","D108",500.0),
            new Drug("Praziquantel Tablet, Film-coated 600mg","D109",500.0),
            new Drug("Albendazole Tablets, Chewable 200mg","D110",500.0),
            new Drug("Albendazole Tablets, Chewable 100mg","D111",500.0),
